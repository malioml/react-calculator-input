  ...
  _createClass(NumericInput, [{
    ...
    value: function render() {
      ...
      var _this$sanitizeRenderP = this.sanitizeRenderProps(props),
          ...
          inputProps = _objectWithoutProperties(_this$sanitizeRenderP, ["label", "calculatorBackground", "labelPosition", "calculatorKeyColor"]);

      return _react.default.createElement("div", {
        className: "numeric-input-component"
      }, props.label && props.labelPosition == "top" && _react.default.createElement("label", {
...
NumericInput.propTypes = {
  ...
  format: _propTypes.default.oneOf(["integer", "float"])
};
